...
!function (e, t) {
  ...
  var C = function (e) {
    ...
    function Ce(e, t, n, r, i, o) {
      return r && !r[b] && (r = Ce(r)), i && !i[b] && (i = Ce(i, o)), le(function (o, a, s, u) {
        ...
        if (n && n(v, m, s, u), r) for (l = Te(m, d), r(l, [], s, u), c = l.length; c--;) {
          (f = l[c]) && (m[d[c]] = !(v[d[c]] = f));
        }
        ...
        if (o) {
          if (i || e) {
            ...
            for (c = m.length; c--;) {
              (f = m[c]) && -1 < (l = i ? P(o, f) : p[c]) && (o[l] = !(a[l] = f));
            }
          }
    ...
    return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye(), a = se.tokenize = function (e, t) {
      ...
      if (!v) {
        ...
        (v = k(e, (i = h, s = 0 < (o = f).length, u = 0 < i.length, c = function c(e, t, n, a, _c) {
          var f,
              h,
              v,
              m = 0,
          ...
          for (_c && (l = t == d || t || _c); y !== S && null != (f = C[y]); y++) {
            if (u && f) {
          ...
          if (m += y, s && y !== m) {
            ...
            if (e) {
              if (0 < m) for (; y--;) {
                x[y] || b[y] || (b[y] = q.call(a));
              }
              b = Te(b);
            }

            H.apply(a, b), _c && !e && 0 < b.length && 1 < m + o.length && se.uniqueSort(a);
          }
  ...
  function xe(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
      if ((o = e[d]) || 0 === o) if ("object" === x(o)) w.merge(p, o.nodeType ? [o] : o);else if (ye.test(o)) {
        for (a = a || f.appendChild(t.createElement("div")), s = (de.exec(o) || ["", ""])[1].toLowerCase(), u = ge[s] || ge._default, a.innerHTML = u[1] + w.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
          a = a.lastChild;
        }
    ...
    for (f.textContent = "", d = 0; o = p[d++];) {
      if (r && -1 < w.inArray(o, r)) i && i.push(o);else if (l = ie(o), a = ve(f.appendChild(o), "script"), l && me(a), n) for (c = 0; o = a[c++];) {
  ...
  w.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      if (V(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(re, i), n.guid || (n.guid = w.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
        ...
        d = g = (s = be.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = w.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = w.event.special[d] || {}, c = w.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
    ...
    handlers: function handlers(e, t) {
      ...
      if (u && l.nodeType && !("click" === e.type && 1 <= e.button)) for (; l !== this; l = l.parentNode || this) {
        if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
          for (o = [], a = {}, n = 0; n < u; n++) {
            void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? -1 < w(i, this).index(l) : w.find(i, this, null, [l]).length), a[i] && o.push(r);
          }
  ...
  function He(e, t, n, r) {
    ...
    var i,
        ...
        v = t[0],
        m = h(v);
    if (m || 1 < p && "string" == typeof v && !d.checkClone && Ae.test(v)) return e.each(function (i) {
      var o = e.eq(i);
    ...
    if (p && (a = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
      ...
      if (u) for (c = s[s.length - 1].ownerDocument, w.map(s, qe), f = 0; f < u; f++) {
        l = s[f], he.test(l.type || "") && !Y.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {
  ...
  function Oe(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++) {
      n || 1 !== r.nodeType || w.cleanData(ve(r)), r.parentNode && (n && ie(r) && me(ve(r, "script")), r.parentNode.removeChild(r));
    }
  ...
  w.extend({
    ...
    clone: function clone(e, t, n) {
      var r,
          ...
          c = e.cloneNode(!0),
          f = ie(e);
      if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = ve(c), r = 0, i = (o = ve(e)).length; r < i; r++) {
  ...
  function ze(e) {
    return w.cssProps[e] || _e[e] || (e in Be ? e : _e[e] = function (e) {
  ...
  w.extend({
    ...
    css: function css(e, t, n, r) {
      var i,
          ...
          a,
          s = X(t);
      return Xe.test(t) || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Ge && (i = Ge[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  ...
  w.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each(function (n) {
        ...
        var t, i, o, a;
        if (r) for (i = 0, o = w(this), a = vt(e); t = a[i++];) {
    ...
    trigger: function trigger(t, n, r, i) {
      ...
      if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !yt.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (x = y.split(".")).shift(), x.sort()), l = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == _typeof(t) && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
        ...
        for (o = 0; (a = m[o++]) && !t.isPropagationStopped();) {
          d = a, t.type = 1 < o ? u : p.bindType || y, (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && V(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
        }

        return t.type = y, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(m.pop(), n) || !V(r) || l && h(r[y]) && !g(r) && ((s = r[l]) && (r[l] = null), w.event.triggered = y, t.isPropagationStopped() && d.addEventListener(y, xt), r[y](), t.isPropagationStopped() && d.removeEventListener(y, xt), w.event.triggered = void 0, s && (r[l] = s)), t.result;
      }
    },
  ...
  Mt.href = bt.href, w.extend({
    ...
    ajax: function ajax(t, n) {
      ...
      if (m.promise(E), d.url = ((t || d.url || bt.href) + "").replace(Ht, bt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(P) || [""], null == d.crossDomain) {
        u = v.createElement("a");
      ...
      if (d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), $t(Ot, d, n, E), l) return E;
      ...
      if (C = "abort", y.add(d.complete), E.done(d.success), E.fail(d.error), r = $t(Pt, d, n, E)) {
  ...
  d.cors = !!Bt && "withCredentials" in Bt, d.ajax = Bt = !!Bt, w.ajaxTransport(function (t) {
    var _n, r;

    if (d.cors || Bt && !t.crossDomain) return {
      send: function send(i, o) {
        ...
        _n = function n(e) {
          return function () {
            _n && (_n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Ft[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
              binary: s.response
            } : {
              text: s.responseText
  ...
  w.ajaxSetup({
    ...
    var r,
        ...
        a = this,
        s = e.indexOf(" ");
    return -1 < s && (r = ht(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), 0 < a.length && w.ajax({
      url: e,
      type: i || "GET",
      dataType: "html",
      data: t
    ...
    w.cssHooks[t] = We(d.pixelPosition, function (e, n) {
      if (n) return n = $e(e, t), Pe.test(n) ? w(e).position()[t] + "px" : n;
    });
  }), w.each({
    Height: "height",
    Width: "width"
  ...
  $(".next").click(function () {
    $(".pagination").find(".pageNumber.active").next().addClass("active"), $(".pagination").find(".pageNumber.active").prev().removeClass("active");
  }), $(".prev").click(function () {
    $(".pagination").find(".pageNumber.active").prev().addClass("active"), $(".pagination").find(".pageNumber.active").next().removeClass("active");
  });
});
